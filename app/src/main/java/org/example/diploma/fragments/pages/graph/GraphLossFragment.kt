...
class GraphLossFragment : Fragment(){
    private var binding: FragmentGraphLossBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentGraphLossBinding.inflate(inflater, container, false)
        return binding!!.root
    }
...
//                if (hehe != 0){
                ...
                val data2Entries = readDataFromFile(it.loss!!)
                ...
                val dataSet2 = LineDataSet(data2Entries, "Losses, Δg = " + it.del_loss.toString()).apply {
