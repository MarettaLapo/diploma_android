...
import org.example.diploma.databinding.FragmentGraphLossBinding
import org.example.diploma.databinding.FragmentGraphTshBinding
import java.io.BufferedReader
import java.io.InputStreamReader

class GraphTshFragment : Fragment(){
    private var binding: FragmentGraphTshBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentGraphTshBinding.inflate(inflater, container, false)
        return binding!!.root
    }
...
//                if (hehe != 0){
                if(it.del_tsh!=null) {
                    ...
                    val data2Entries = readDataFromFile(it.tsh!!)

                    val dataSet1 = LineDataSet(
                        data1Entries,
                        "Output power, ΔP = " + it.del_sout.toString() + " kW"
                    ).apply {
                        color = R.color.black
                    ...
                    val dataSet2 =
                        LineDataSet(data2Entries, "Tsh, ΔT = " + it.del_tsh.toString()).apply {
